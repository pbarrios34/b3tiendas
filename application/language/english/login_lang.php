...
$lang['login_welcome_message']='Welcome to the %BRANDING_NAME% System. To continue, please login using your username and password below.';
...
$lang['login_resign_text'] = 'Your subscription to %BRANDING_NAME% was cancelled. If this was in error please signup again using the following links:';


$lang['login_force_password_change'] = 'You must change your password as required by person who created your account';
$lang['login_payment_failed_text'] = 'Your payment for %BRANDING_NAME% has failed. Please follow the below link for instructions on how to update your credit card in paypal';
...
$lang['login_trial_over'] = 'Your trial for %BRANDING_NAME% has ended. To continue using %BRANDING_SHORT_NAME% you can click the link below to enter billing information';
$lang['login_activate'] = 'Activate account\'s billing information';
$lang['login_resignup'] = 'Re-Signup for %BRANDING_NAME%';
