      ...
      <div class="col-md-12 woo_settings ecom_settings <?php echo $woo_hidden_class; ?>">
	     ...
	     <div class="col-md-12">
			...
			<div class="col-md-12">
				<div class="panel panel-piluku">
					<div class="panel-heading">
						<a data-toggle="collapse" data-parent="#collapsePanels" href="#felplex_config">
							<?php echo create_section(lang('config_felplex_config'), 'felplex-configuration-options', 'section-felplex-settings')  ?>
						</a>
					</div>	
					<div id="felplex_config" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
						<div class="panel-body">
							<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_store_accounts')) ?>">	
								<?php echo form_label(lang('config_base_url_felplex').':', 'base_url_felplex',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
								<div class="col-sm-9 col-md-9 col-lg-10">
									<?php echo form_input(array(
									'class'=>'form-control form-inps',
									'name'=>'base_url_felplex',
									'id'=>'base_url_felplex',
									'placeholder' => 'https://felplex.stage.plex.lat',
									'value'=>$this->config->item('base_url_felplex')));?>
								</div>
							</div>

							<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_store_accounts')) ?>">	
								<?php echo form_label(lang('config_entity_id_felplex').':', 'entity_id_felplex',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
								<div class="col-sm-9 col-md-9 col-lg-10">
									<?php echo form_input(array(
									'class'=>'form-control form-inps',
									'name'=>'entity_id_felplex',
									'id'=>'entity_id_felplex',
									'placeholder' => '150',
									'value'=>$this->config->item('entity_id_felplex')));?>
								</div>
							</div>

							<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_store_accounts')) ?>">	
								<?php echo form_label(lang('config_api_key_felplex').':', 'api_key_felplex',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
								<div class="col-sm-9 col-md-9 col-lg-10">
									<?php echo form_input(array(
									'class'=>'form-control form-inps',
									'name'=>'api_key_felplex',
									'id'=>'api_key_felplex',
									'value'=>$this->config->item('api_key_felplex')));?>
								</div>
							</div>
