			...
			<div class="panel-body">
					<?php echo form_open("receivings/save/".$receiving_info['receiving_id'],array('id'=>'receivings_edit_form','class'=>'form-horizontal')); ?>
						...
						<?php echo form_label(lang('common_date').':', 'date',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
							<div class="col-sm-9 col-md-9 col-lg-10 sale-s">
								<?php echo form_input( array( 'value'=>date(get_date_format()." ".get_time_format(), strtotime($receiving_info['receiving_time'])), 'id'=>'#', 'class'=>'form-control' ), $value="", $extra="readonly" );?>
							</div>
						</div>
						...
						<?php echo form_label(lang('receivings_supplier').':', 'supplier',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
							<div class="col-sm-9 col-md-9 col-lg-10 sale-s">
								<?php if (!$store_account_payment && !$store_account_charge) { ?>
									<?php
										if( $this->Employee->has_module_action_permission('receivings', 'show_can_deleted_supplier', $this->Employee->get_logged_in_employee_info()->person_id) ) {
											echo form_dropdown('supplier_id', $suppliers, $receiving_info['supplier_id'], 'id="supplier_id"');
										} else {
											echo form_input( array( 'value'=>$suppliers[$receiving_info['supplier_id']], 'id'=>'#', 'class'=>'form-control' ), $value="", $extra="readonly" );
										}
									?>
						...
						<?php echo form_label(lang('common_employee').':', 'employee',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
							<div class="col-sm-9 col-md-9 col-lg-10 sale-s">
								<?php
									echo form_dropdown('employee_id', $employees, $receiving_info['employee_id'], 'class="form-control valid" id="employee_id" style="display:none;"');
									echo form_input( array( 'value'=>$employees[$receiving_info['employee_id']], 'id'=>'#', 'class'=>'form-control' ), $value="", $extra="readonly" );
								?>
							</div>
						</div>
