...
$init_date_recv = $this->Receiving->get_info($receiving_id_raw)->result_array(  )[0]['rev_creation_date'];
			...
			<div class="panel-body panel-pad">
				<div class="row">
					<div class="col-md-4 col-sm-4 col-xs-12">
						<ul class="list-unstyled invoice-address">
							...
							<li id="sale_receipt"><b><?php echo H(lang( "receivings_receipt_date" )); ?></b></li>
							<li id="sale_time"><?php echo H(date("d/m/y H:i:s", strtotime($transaction_time))); ?></li>
							<li id="sale_recv_init_label"><b><?php echo H(lang( "receivings_creation_date" )); ?></b></li>
							<li id="sale_time_init"><?php echo H(date("d/m/y H:i:s", strtotime($init_date_recv))); ?></li>
						</ul>
					</div>
					<!--  sales-->
					<div class="col-md-4 col-sm-4 col-xs-12">
				...
				<table style="width: 100%;" id="receipt-table">
						...
						<tr>
							...
							<th class="invoice-table">
								<div class="row">
									...
									<div class="<?php echo $this->config->item('wide_printer_receipt_format') ? 'col-md-' . $x_col . ' col-sm-' . $x_col . ' col-xs-' . $x_col : 'col-md-12 col-sm-12 col-xs-12' ?>">
										<div class="invoice-head item-name"><?php echo lang('common_item_number_expanded', '', array(), TRUE); ?></div>
									</div>
									...
									?>
										<div class="col-md-<?php echo $xs_col; ?> col-sm-<?php echo $xs_col; ?> col-xs-<?php echo $xs_col; ?> gift_receipt_element">
											<div class="invoice-head text-right item-price"><?php echo lang('common_current_cost', '', array(), TRUE); ?></div>
										</div>
										<div class="col-md-<?php echo $xs_col; ?> col-sm-<?php echo $xs_col; ?> col-xs-<?php echo $xs_col; ?> gift_receipt_element">
											<div class="invoice-head text-right item-price"><?php echo lang('common_previous_cost', '', array(), TRUE); ?></div>
										</div>
									<?php } ?>
									<div class="col-md-<?php echo $xs_col; ?> col-sm-<?php echo $xs_col; ?> col-xs-<?php echo $xs_col; ?>">
										<div class="invoice-head text-right item-qty"><?php echo lang('common_quantity_original', '', array(), TRUE); ?></div>
									</div>
									<div class="col-md-<?php echo $xs_col; ?> col-sm-<?php echo $xs_col; ?> col-xs-<?php echo $xs_col; ?>">
										<div class="invoice-head text-right item-qty"><?php echo lang('common_quantity_received', '', array(), TRUE); ?></div>
									</div>
									<?php
									if (!$this->config->item('hide_all_prices_on_recv') && $has_cost_price_permission) {
									?>
										...
										<?php if ($discount_exists) { ?>
											...
											<div class="col-md-<?php echo $xs_col_last; ?> col-sm-<?php echo $xs_col_last; ?> col-xs-<?php echo $xs_col_last; ?>">
												<div class="invoice-head pull-right item-total gift_receipt_element"><?php echo lang('reports_difference', '', array(), TRUE); ?></div>
											</div>
											<div class="col-md-<?php echo $xs_col_last; ?> col-sm-<?php echo $xs_col_last; ?> col-xs-<?php echo $xs_col_last; ?>">
					...
					?>
						...
						if ($item->quantity_received > 0 && $item->name != lang('common_store_account_payment', '', array(), TRUE) && $item->name != lang('common_discount', '', array(), TRUE) && $item->name != lang('common_refund', '', array(), TRUE) && $item->name != lang('common_fee', '', array(), TRUE)) {
							$number_of_items_sold = $number_of_items_sold + $item->quantity_received;
						} elseif ($item->quantity_received < 0 && $item->name != lang('common_store_account_payment', '', array(), TRUE) && $item->name != lang('common_discount', '', array(), TRUE) && $item->name != lang('common_refund', '', array(), TRUE) && $item->name != lang('common_fee', '', array(), TRUE)) {
							$number_of_items_returned = $number_of_items_returned + abs($item->quantity_received);
						}
										...
										<div class="row receipt-row-item-holder">
											<div class="<?php echo $this->config->item('wide_printer_receipt_format') ? 'col-md-' . $x_col . ' col-sm-' . $x_col . ' col-xs-' . $x_col : 'col-md-12 col-sm-12 col-xs-12' ?>">
												<div class="invoice-content invoice-con">
													...
													<div class="invoice-content-heading"><?php echo H($item->item_number);?></div>
											...
											?>
												...
												<div class="col-md-<?php echo $xs_col; ?> col-sm-<?php echo $xs_col; ?> col-xs-<?php echo $xs_col; ?> gift_receipt_element">
													...
													?>
														<div class="invoice-content item-price text-right"><?php echo to_currency($this->Receiving->get_actual_cost_in_recv( $receiving_id_raw, $item->item_id ), 10); ?>
															<?php
												...
												<div class="col-md-<?php echo $xs_col; ?> col-sm-<?php echo $xs_col; ?> col-xs-<?php echo $xs_col; ?> gift_receipt_element">
													...
													if ($has_cost_price_permission) {
													?>
														<div class="invoice-content item-price text-right"><?php echo to_currency($this->Receiving->get_previous_cost_in_recv( $receiving_id_raw, $item->item_id ), 10); ?>
															<?php
															if ($this->config->item('show_selling_price_on_recv')) {
																echo '<br />' . lang('common_previous_cost') . ': ' . to_currency($item->cost_price, 10);
															}
															?>
														</div>
													<?php } ?>
											...
											<div class="col-md-<?php echo $xs_col; ?> col-sm-<?php echo $xs_col; ?> col-xs-<?php echo $xs_col; ?> gift_receipt_element">
												<div class="invoice-content item-qty text-right">
													<?php echo is_null( $item->quantity_received ) ? to_quantity($item->quantity) : to_quantity( $item->quantity_received ) ?>
												</div>
											</div>
											...
											?>
												...
												<?php if ($discount_exists) { ?>
													<div class="col-md-<?php echo $xs_col_last; ?> col-sm-<?php echo $xs_col_last; ?> col-xs-<?php echo $xs_col_last; ?> gift_receipt_element">
														<div class="invoice-content item-total pull-right <?php echo ($mode == 'transfer' && !$see_cost_price) ? "hide" : ""; ?>">
															...
															<?php $dif=$item->cost_price * $item->quantity_received - $item->cost_price * $item->quantity_received * $item->discount / 100; 
															$dif2=$item->unit_price * $item->quantity_received - $item->unit_price * $item->quantity_received * $item->discount / 100;
															echo to_currency($dif2-$dif, 10); ?>
														...
														<div class="invoice-content item-total pull-right <?php echo ($mode == 'transfer' && !$see_cost_price) ? "hide" : ""; ?>">
															...
															<?php
																if( $item->quantity_received === NULL ) {
																	$tq = ( $item->unit_price * $item->quantity ) - ( ( $item->unit_price * $item->quantity * $item->discount ) / 100 );
																	echo ($cart->suspended == 1) ? "Supuesto a Pagar: ".to_currency($tq, 10) : to_currency($tq, 10);
																	$general_total_cart += $tq;
																} elseif( !is_null( $item->quantity_received ) && ( $item->quantity_received >= 0 ) ) {
																	$tq = ( $item->unit_price * $item->quantity_received ) - ( ( $item->unit_price * $item->quantity_received * $item->discount ) / 100 );
																	echo ($cart->suspended == 1) ? "Supuesto a Pagar: ".to_currency($tq, 10) : to_currency($tq, 10);
																	$general_total_cart += $tq;
																}
															/*echo to_currency($item->unit_price * $item->quantity_received - $item->unit_price * $item->quantity_received * $item->discount / 100, 10);*/
															?>
														</div>
													</div>
				...
				<?php if ($exchange_name) { ?>
					...
					<div class="row">
						...
						<div class="col-md-2 col-sm-2 col-xs-4">
							<div class="invoice-footer-value"><?php echo to_currency_no_money($exchange_rate); ?></div>
						</div>
					</div>
					...
					<div class="row <?php echo ($mode == 'transfer' && !$see_cost_price) ? "hide" : ""; ?>">
						...
						<div class="col-md-2 col-sm-2 col-xs-4">
							<div class="invoice-footer-value" style="font-size: 150%;font-weight: bold;;">
								<?php
								if (isset($exchange_name) && $exchange_name) {
									echo to_currency_as_exchange($cart, $general_total_cart);
								} else {
									echo to_currency($general_total_cart);
								}
								?>
							</div>
						</div>
