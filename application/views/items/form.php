	...
	<div class="panel panel-piluku">
        ...
        <div class="form-group">
				...
				<div class="form-group">
						...
						<?php echo form_label(lang('items_need_expiration').':', '',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
						<?php echo form_checkbox(array(
							'name'=>'item_expiration',
							'id'=>'item_expiration',
							'class' => 'item_expiration delete-checkbox',
							'value'=>1,
							'checked'=> !empty($item_info->item_id) ? ( !empty( $item_info->expiration ) ? (boolean)($item_info->expiration) : false ) : true
						));
						?>
						<label for="item_expiration"><span></span></label>
					</div>
				</div>
