			...
			<div class="panel-body">
				...
				<?php if ($progression || $this->Employee->has_module_action_permission('items','see_cost_price', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
					<div class="form-group">
						<?php echo form_label(lang('common_previous_cost').' ('.lang('common_without_tax').')'.':', 'previous_cost',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label required wide')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
							<div class="input-group">
								...
								<?php echo form_input(array(
									...
									'value'=>$item_info->cost_price ? to_currency_no_money($item_info->previous_cost,10) : '')
								);?>
							</div>
						</div>
					</div>
