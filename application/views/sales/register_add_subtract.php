		...
		<div class="panel panel-piluku">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<?php echo form_label(lang('sales_transaction_type').':', 'note',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
				    <div class="col-sm-9 col-md-9 col-lg-10">
					<?php echo form_dropdown('transaction_type', array(
									'common_cash'=> lang('common_cash'),
									'common_check'=>lang('common_check'),
									'common_giftcard'=>lang('common_giftcard'),
									'common_debit'=>lang('common_debit'),
									'common_credit'=>lang('common_credit'),
								), 
						$this->config->item('transaction_type'),
