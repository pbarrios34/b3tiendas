						...
						if ($item->tax_included) {
							if (get_class($item) == 'PHPPOSCartItemSale') {
								if ($item->tax_included) {
									...
									$unit_price = to_currency_no_money(get_price_for_item_including_taxes($line, $item->unit_price, $sale_id_raw));
								...
								if ($item->tax_included) {
									...
									$unit_price = to_currency_no_money(get_price_for_item_kit_including_taxes($line, $item->unit_price, $sale_id_raw));
									$price_including_tax = $unit_price;
