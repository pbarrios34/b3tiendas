			...
			<div class="col-md-12">
				<div class="panel panel-piluku">
					<div class="panel-heading">
						<h3 class="panel-title">
							<i class="ion-edit"></i> 
							<?php echo lang("config_felplex_config"); ?>
							<small>(<?php echo lang('common_fields_required_message'); ?>)</small>
						</h3>
					</div>
					...
					<div class="panel-body">
						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_store_accounts')) ?>">	
							<?php echo form_label(lang('config_base_url_felplex').':', 'location_url_felplex',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-md-9 col-lg-10">
								<?php echo form_input(array(
								'class'=>'form-control form-inps',
								'name'=>'location_url_felplex',
								'id'=>'location_url_felplex',
								'placeholder' => 'https://felplex.stage.plex.lat',
								'value'=>($location_info->location_url_felplex ? $location_info->location_url_felplex : '')));?>
							</div>
						</div>

						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_store_accounts')) ?>">	
							<?php echo form_label(lang('config_entity_id_felplex').':', 'location_entity_id_felplex',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-md-9 col-lg-10">
								<?php echo form_input(array(
								'class'=>'form-control form-inps',
								'name'=>'location_entity_id_felplex',
								'id'=>'location_entity_id_felplex',
								'placeholder' => '150',
								'value'=>($location_info->location_entity_felplex ? $location_info->location_entity_felplex : '')));?>
							</div>
						</div>

						<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_store_accounts')) ?>">	
							<?php echo form_label(lang('config_api_key_felplex').':', 'location_api_key_felplex',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
							<div class="col-sm-9 col-md-9 col-lg-10">
								<?php echo form_input(array(
								'class'=>'form-control form-inps',
								'name'=>'location_api_key_felplex',
								'id'=>'location_api_key_felplex',
								'value'=>($location_info->location_key_felplex ? $location_info->location_key_felplex : '')));?>
							</div>
						</div>
					</div>
				</div>
