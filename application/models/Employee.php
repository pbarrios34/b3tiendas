...
class Employee extends Person
{
	...
	*/
	...
	function get_register_cash_columns_to_display(){
		$this->load->model('Sale');
		
		$all_columns = $this->Sale->get_register_cash_displayable_columns();
		
		$columns_to_display = array();
		
		$this->load->model('Employee_appconfig');
		if ($choices = $this->Employee_appconfig->get('register_cash_column_prefs'))
		{
			$columns_to_display_keys = unserialize($choices);
		}
		else
		{
			$columns_to_display_keys = $this->Sale->get_register_cash_default_columns();
    ...
    function get_register_by_default_by_employee($employee_id) {
