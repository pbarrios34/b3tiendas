...
abstract class PHPPOSCartItemBase
{
	...
	public function get_subtotal_receivings()
	{
		...
		{
			return to_currency_no_money(($this->get_modifiers_subtotal() - ($this->get_modifiers_subtotal() * $this->discount / 100))+ ($this->unit_price*$this->quantity_received-$this->unit_price*$this->quantity_received*$this->discount/100));
		}
		/*return to_currency_no_money(($this->get_modifiers_subtotal() - ($this->get_modifiers_subtotal() * $this->discount / 100))+ ($this->unit_price*$this->quantity_received-$this->unit_price*$this->quantity_received*$this->discount/100));*/
	}
