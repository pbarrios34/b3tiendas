	...
	function save_customer(&$person_data, &$customer_data,$customer_id=false,$skip_webhook = false)
	{
		...
		if(parent::save($person_data,$customer_id))
		{
			...
			if (!$customer_id or !$this->exists($customer_id))
			{
				...
				$customer_data['company_name'] = $person_data['full_name'];
				$customer_data['account_number'] = $_POST['sales_nit_name'] === 'CF' ? '' : $_POST['sales_nit_name'] ;
				$customer_data['auto_email_receipt'] = $_POST['auto_email_name'] ? $_POST['auto_email_name'] : 0;
			...
			else
			{
				...
				{
					$customer_data['company_name'] = $person_data['full_name'];
					$customer_data['account_number'] = ( isset( $_POST['account_number'] ) ) ? $_POST['account_number'] : $_POST['sales_nit_name'];
					$customer_data['auto_email_receipt'] = $_POST['auto_email_name'] ? $_POST['auto_email_name'] : 0;
