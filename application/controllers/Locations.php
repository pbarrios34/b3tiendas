...
class Locations extends Secure_area implements Idata_controller
{
	...
	*/
	...
	function save($location_id=-1)
	{
		...
		'location_url_felplex' => $this->input->post('location_url_felplex') ? $this->input->post('location_url_felplex') : '',
		'location_entity_felplex' => $this->input->post('location_entity_id_felplex') ? $this->input->post('location_entity_id_felplex') : 0,
		'location_key_felplex' => $this->input->post('location_api_key_felplex') ? $this->input->post('location_api_key_felplex') : '',
	);
